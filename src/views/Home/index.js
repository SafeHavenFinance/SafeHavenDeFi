...
const landingMedit =
  "https://video.wixstatic.com/video/7733e8_3833a23222b84a30ba644e124e0c2840/1080p/mp4/file.mp4";
...
export default function Home() {
  ...
  // videos
  const videoLandingRef = useRef();
  const videoTokenRef = useRef();
  useEffect(() => {
    if (isSafari() && videoLandingRef.current) {
      const player = videoLandingRef.current.children[0];
    ...
    if (isSafari() && videoTokenRef.current) {
      const player = videoTokenRef.current.children[0];
    ...
    <div>
      ...
      >
        ...
        <div
          ...
          >
            <source src="https://video.wixstatic.com/video/7733e8_3833a23222b84a30ba644e124e0c2840/1080p/mp4/file.mp4" type="video/mp4" />
          </video>
          `,
          }}
        ></div>
      ...
      >
        ...
        <div
          ...
          <video
            ...
            role="presentation"
            preload="auto"
            class="${classes.earnEthPassivelyVideo}"
          >
